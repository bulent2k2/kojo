...
açı(n2, n1)
  ...
  val koleksiyonYöntemleri: List[(String, String, String, String, String, String)] = List(
    ...
    ("""sil""", """sil()""", """Yığını/kuyruğu tümüyle boşaltır.""", """{ dez y = Yığın(1, 2); y.sil(); y.tane }""", """0""", """EsnekDizim, Kuyruk, Yığın, ÖncelikSırası"""),
    ...
    ("""ekle""", """ekle(öge)""", """Kuyruğa/öncelik sırasına öge ekler.""", """Kuyruk(1).ekle(2).dizine""", """Dizin(1, 2)""", """EsnekDizik, EsnekDizim, Kuyruk, ÖncelikSırası"""),
    ...
    ("""harf""", """harf(sıra)""", """Yazının o sıradaki harfi. 0'dan başlar.""", """"merhaba".harf(0)""", """m""", """Yazı"""),
    ("""parçası""", """parçası(nereden, nereye)""", """Yazının bir parçasını keser. nereye dahil değil.""", """"merhaba".parçası(0, 3)""", """mer""", """Yazı"""),
    ...
    ("""sayıya""", """sayıya""", """Yazıyı Sayı'ya çevirir. Sayı değilse hata verir.""", """"42".sayıya""", """42""", """Harf, Yazı"""),
    ("""sayıyaBelki""", """sayıyaBelki""", """sayıya'nın hata vermeyeni: olmuyorsa Hiçbiri.""", """"kırk".sayıyaBelki""", """Hiçbiri""", """Yazı"""),
    ("""kesire""", """kesire""", """Yazıyı Kesir'e (ondalıklı sayı) çevirir.""", """"3.5".kesire""", """3.5""", """Harf, Yazı"""),
