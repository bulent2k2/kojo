...
açı(n2, n1)
  ...
  val koleksiyonYöntemleri: List[(String, String, String, String, String)] = List(
    ...
    ("""indirgeBelki""", """indirgeBelki(işlem)""", """indirge'nin hata vermeyeni: boş toplulukta Hiçbiri verir.""", """Dizin[Sayı]().indirgeBelki(_ + _)""", """None"""),
    ("""indirgeSoldanBelki""", """indirgeSoldanBelki(işlem)""", """indirgeSoldan'ın Belki veren biçimi.""", """Dizin(1, 2, 3).indirgeSoldanBelki(_ + _)""", """Some(6)"""),
    ("""indirgeSağdanBelki""", """indirgeSağdanBelki(işlem)""", """indirgeSağdan'ın Belki veren biçimi.""", """Dizin[Sayı]().indirgeSağdanBelki(_ + _)""", """None"""),
    ...
    ("""elekle""", """elekle(deneme)""", """ele gibi ama tembel. Doğrudan pek çağrılmaz: `için` döngüsündeki `eğer` süzgecini derleyici buna çevirir.""", """için (x <- Biri(5) eğer x > 1) ver x * 10""", """Some(50)"""),
    ...
    ("""koy""", """koy(anahtar, değer)""", """Eşlem'e koyar; o anahtarda eskiden ne varsa Belki içinde verir. (Yığın'da koy = it demek.)""", """Eşlem("a" -> 1).koy("a", 9)""", """Some(1)"""),
    ...
    ("""kaldır""", """kaldır""", """Eşleği bir işleve çevirir: anahtarı verirsin, Belki alırsın.""", """Eşlek("a" -> 1).kaldır("yok")""", """None"""),
    ...
    ("""baştanÇıkarBelki""", """baştanÇıkarBelki""", """baştanÇıkar'ın hata vermeyeni: boş kuyrukta Hiçbiri.""", """Kuyruk.boş[Sayı].baştanÇıkarBelki""", """None"""),
    ...
    ("""baştanÇıkarKoşulla""", """baştanÇıkarKoşulla(deneme)""", """Koşula uyan İLK ögeyi bulup çıkarır (baştaki olmak zorunda değil).""", """{ dez k = Kuyruk(1, 2, 3); k.baştanÇıkarKoşulla(_ > 1) }""", """Some(2)"""),
    ...
    ("""sayıyaBelki""", """sayıyaBelki""", """sayıya'nın hata vermeyeni: olmuyorsa Hiçbiri.""", """"kırk".sayıyaBelki""", """None"""),
    ...
    ("""sıradakiBelki""", """sıradakiBelki""", """sıradaki'nin hata vermeyeni: bitmişse Hiçbiri.""", """Dizin[Sayı]().yineleyici.sıradakiBelki""", """None"""),
