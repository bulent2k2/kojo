...
açı(n2, n1)
  ...
  val koleksiyonYöntemleri: List[(String, String, String, String, String, String)] = List(
    ...
    ("""sıralar""", """sıralar""", """Ögelerin sıra numaraları: 0, 1, 2, ...""", """Dizin(3, 1, 2).sıralar.dizine""", """Dizin(0, 1, 2)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ...
    ("""bulSondan""", """bulSondan(deneme)""", """Denemeye uyan SON ögeyi verir.""", """Dizin(1, 2, 3).bulSondan(_ < 3)""", """Biri(2)""", """Aralık, Dizi, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yöney, Yığın"""),
    ...
    ("""sırası""", """sırası(öge)""", """Ögenin kaçıncı sırada olduğu. Yoksa -1.""", """Dizin(3, 1, 2).sırası(1)""", """1""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yineleyici, Yöney, Yığın"""),
    ("""nerede""", """nerede(deneme)""", """Denemeye uyan ilk ögenin sırası. Yoksa -1.""", """Dizin(3, 1, 2).nerede(_ < 2)""", """1""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yineleyici, Yöney, Yığın"""),
    ("""başındaMı""", """başındaMı(dizi)""", """Topluluk bu dizi ile başlıyor mu.""", """Dizin(1, 2, 3).başındaMı(Dizin(1, 2))""", """doğru""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""sonundaMı""", """sonundaMı(dizi)""", """Topluluk bu dizi ile bitiyor mu.""", """Dizin(1, 2, 3).sonundaMı(Dizin(2, 3))""", """doğru""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""karşılıklıMı""", """karşılıklıMı(öbürü)(deneme)""", """İki topluluğu öge öge karşılaştırır.""", """Dizin(1, 2).karşılıklıMı(Dizin(2, 4))((a, b) => b == a * 2)""", """doğru""", """Aralık, Dizi, Dizin, EsnekDizik, Eşlek, Kuyruk, MiskinDizin, Yineleyici, Yöney, Yığın"""),
    ("""sıralı""", """sıralı""", """Ögeleri küçükten büyüğe dizer.""", """Dizin(3, 1, 2).sıralı""", """Dizin(1, 2, 3)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""sırala""", """sırala(iş)""", """İşlevin verdiği değere göre sıralar.""", """Dizin("aaa", "a", "aa").sırala(_.boyu)""", """Dizin(a, aa, aaa)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""sırayaSok""", """sırayaSok(önce)""", """Hangi öge önce gelsin, sen söyle.""", """Dizin(1, 3, 2).sırayaSok(_ > _)""", """Dizin(3, 2, 1)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""tersi""", """tersi""", """Ögeleri ters sıraya çevirir.""", """Dizin(1, 2, 3).tersi""", """Dizin(3, 2, 1)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın, ÖncelikSırası"""),
    ("""yinelemesiz""", """yinelemesiz""", """Yinelenen ögelerin yalnız ilkini tutar.""", """Dizin(1, 2, 1, 3).yinelemesiz""", """Dizin(1, 2, 3)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yineleyici, Yöney, Yığın"""),
    ...
    ("""kombinasyonlar""", """kombinasyonlar(kaçTane)""", """Bu kadar ögeli tüm alt seçimler (sıra önemsiz).""", """Dizin(1, 2, 3).kombinasyonlar(2).dizine""", """Dizin(Dizin(1, 2), Dizin(1, 3), Dizin(2, 3))""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""permütasyonlar""", """permütasyonlar""", """Ögelerin tüm sıralanışları.""", """Dizin(1, 2).permütasyonlar.dizine""", """Dizin(Dizin(1, 2), Dizin(2, 1))""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ...
    ("""sonunaEkle""", """sonunaEkle(öge)""", """Sonuna bir öge eklenmiş YENİ topluluk verir.""", """Dizin(1, 2).sonunaEkle(3)""", """Dizin(1, 2, 3)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""önüneEkle""", """önüneEkle(öge)""", """Başına bir öge eklenmiş YENİ topluluk verir.""", """Dizin(2, 3).önüneEkle(1)""", """Dizin(1, 2, 3)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ...
    ("""uzat""", """uzat(boy, öge)""", """Bu boya erişene dek sonuna ögeyi ekler.""", """Dizin(1, 2).uzat(4, 0)""", """Dizin(1, 2, 0, 0)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yineleyici, Yöney, Yığın"""),
    ("""yama""", """yama(nereden, yenisi, kaçTane)""", """Bir parçayı söküp yerine başkasını koyar.""", """Dizin(1, 2, 3).yama(1, Dizin(8, 9), 1)""", """Dizin(1, 8, 9, 3)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yineleyici, Yöney, Yığın"""),
    ...
    ("""yinelemesizİşlevle""", """yinelemesizİşlevle(işlev)""", """İşlevin verdiği değere göre yinelenenleri atar.""", """Dizin("al", "at", "be").yinelemesizİşlevle(_.harf(0))""", """Dizin(al, be)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yineleyici, Yöney, Yığın"""),
    ("""sonunaEkleHepsini""", """sonunaEkleHepsini(öbürü)""", """Sonuna bir topluluğun tümünü ekler.""", """Dizin(1, 2).sonunaEkleHepsini(Dizin(3, 4))""", """Dizin(1, 2, 3, 4)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""önüneEkleHepsini""", """önüneEkleHepsini(öbürü)""", """Başına bir topluluğun tümünü ekler.""", """Dizin(3, 4).önüneEkleHepsini(Dizin(1, 2))""", """Dizin(1, 2, 3, 4)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""neredeSondan""", """neredeSondan(deneme)""", """Denemeye uyan SON ögenin sırası.""", """Dizin(1, 2, 3, 2).neredeSondan(_ == 2)""", """3""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""sırasıSondan""", """sırasıSondan(öge)""", """Ögenin son geçtiği sıra.""", """Dizin(1, 2, 3, 2).sırasıSondan(2)""", """3""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""içeriyorMuDilim""", """içeriyorMuDilim(dilim)""", """Bu alt dizi topluluğun içinde geçiyor mu.""", """Dizin(1, 2, 3).içeriyorMuDilim(Dizin(2, 3))""", """doğru""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
    ("""dilimSırası""", """dilimSırası(dilim)""", """Alt dizinin başladığı sıra. Yoksa -1.""", """Dizin(1, 2, 3).dilimSırası(Dizin(2, 3))""", """1""", """Aralık, Dizi, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yöney, Yığın"""),
    ...
    ("""tersİşle""", """tersİşle(işlev)""", """Önce ters çevirir, sonra işler.""", """Dizin(1, 2, 3).tersİşle(_ * 10)""", """Dizin(30, 20, 10)""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Kuyruk, MiskinDizin, Yöney, Yığın"""),
    ...
    ("""koy""", """koy(anahtar, değer)""", """Eşlem'e koyar; o anahtarda eskiden ne varsa Belki içinde verir. (Yığın'da koy = it demek.)""", """Eşlem("a" -> 1).koy("a", 9)""", """Biri(1)""", """Eşlem, Yığın"""),
    ...
    ("""tane""", """tane""", """Kaç öge var. boyu ile aynı (kitapçık adı).""", """Yığın(1, 2, 3).tane""", """3""", """Yığın"""),
    ("""dizi""", """dizi""", """İçeriği Dizi olarak verir. Yığında tepeden dibe.""", """Yığın(1, 2, 3).dizi""", """Dizin(3, 2, 1)""", """EsnekDizim, Eşlek, Eşlem, Yığın"""),
    ("""sil""", """sil()""", """Yığını/kuyruğu tümüyle boşaltır.""", """{ dez y = Yığın(1, 2); y.sil(); y.tane }""", """0""", """EsnekDizim, EsnekYazı, Kuyruk, Yığın, ÖncelikSırası"""),
    ...
    ("""ekle""", """ekle(öge)""", """Kuyruğa/öncelik sırasına öge ekler.""", """Kuyruk(1).ekle(2).dizine""", """Dizin(1, 2)""", """EsnekDizik, EsnekDizim, EsnekYazı, Kuyruk, ÖncelikSırası"""),
    ("""ikizle""", """ikizle()""", """Topluluğun bir kopyasını verir; özgünü bozulmaz.""", """{ dez ö = ÖncelikSırası(1, 5); dez k = ö.ikizle(); k.baştanAl(); ö.boyu }""", """2""", """Kuyruk, ÖncelikSırası"""),
    ("""baştanAl""", """baştanAl()""", """Öncelik sırasında EN İRİ ögeyi alır ve çıkarır.""", """ÖncelikSırası(3, 9, 5).baştanAl()""", """9""", """Kuyruk, ÖncelikSırası"""),
    ...
    ("""değiştir""", """değiştir(eski, yeni)""", """Yazıdaki bütün eski parçaları yenisiyle değiştirir.""", """"ali ali".değiştir("ali", "veli")""", """veli veli""", """Aralık, Dizi, Dizik, Dizin, EsnekDizik, Eşlem, Kuyruk, MiskinDizin, Yazı, Yöney, Yığın"""),
